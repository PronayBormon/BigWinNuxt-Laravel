...
const addChampionresult = () => {
    ...
    axios.post('api/result/champion', formData).then(response => {
...
const addFinalPredictionResult = () => {
    ...
    axios.post('api/result/final', formData).then(response => {
        $notyf.success(response.data.message);
        // console.log(response.data);
        let modalElement = document.getElementById('result');
        if (modalElement) {
...
const addSemiFinalPredictionResult = () => {
    ...
    axios.post('/api/result/semi-final', formData).then(response => {
        // console.log(response.data);
        $notyf.success(response.data.message);
        let modalElement = document.getElementById('result');
        if (modalElement) {
