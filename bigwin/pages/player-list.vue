...
const updatePlayer = () =>{
    ...
    axios.post('api/update-player', formData).then( response =>{
        getPlayers();
...
const playerDetails = (id) =>{
    axios.get(`api/get-player-details/${id}`).then( response =>{
        // console.log(response.data);
        player_id.value = response.data.id;
        editplayer_name.value = response.data.player_name;
...
const addPlayer = () => {
    ...
    axios.post('api/add-team-player', formData).then( response =>{
        getPlayers();
...
const getPlayers = (page) =>{
    axios.get(`api/get-team-players`,{
        params: {
            items: items.value,
