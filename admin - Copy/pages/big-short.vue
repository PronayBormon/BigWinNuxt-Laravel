        ...
        <div class="main_content">
            ...
            <div class="content_section">
                <div class="d-flex justify-content-between align-items-center">
                    <h1 class="page_title">Add Big short Match</h1>
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in matchList" :key="index">
                                        ...
                                        <td class="text-center">
                                            ...
                                            {{ item.team_a ? item.team_a.name : 'N/A' }}
                                        </td>
                                        <td>
                                            {{ item.team_a ? item.team_b.name : 'N/A' }}
                                        </td>
...
const updateMatch = () => {
    ...
    axios.post('bigshort/update-match', formData).then(response => {
        editteamA.value = "";
        editteamB.value = "";
        editdateTime.value = "";
...
const getdetails = (id) => {
    axios.get(`bigshort/bigshort-details/${id}`).then(response => {
        console.log(response.data);

        
        editteamA.value = response.data.team_a.id;
        editteamB.value = response.data.team_b.id;
        editdateTime.value = response.data.start_date;
...
const addMatch = () => {
    ...
    axios.post('bigshort/save-bigshort', formData).then(response => {
        // console.log(response.data);
        getMatchList();
        $notyf.success(response.data.message);
        teamA.value = "";
...
const getMatchList = (pages) => {
    ...
    axios.get('bigshort/bigshort-matchlist', {
        params: {
            items: items.value,
