...
class Country extends Model
{
    ...
    public function bigShortsAsTeamOne()
    {
        return $this->hasMany(BigShort::class, 'team_one', 'id');
    }

    public function bigShortsAsTeamTwo()
    {
        return $this->hasMany(BigShort::class, 'team_two', 'id');
    }
}
